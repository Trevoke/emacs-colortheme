;;; big-softy-theme.el --- Emacs 24 theme with a dark background.

;; Copyright (C) 2014 , Aldric "Trevoke" Giacomoni

;; Author: Aldric "Trevoke" Giacomoni
;; http://github.com/trevoke/big-softy.el
;; Version: 0.1
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'big-softy
	...
	`(org-level-1 ((,class (:bold t :foreground ,type :height 1.1))))
	`(org-level-2 ((,class (:bold nil :foreground ,builtin))))
	`(org-level-3 ((,class (:bold t :foreground ,key2))))
...
(provide-theme 'big-softy)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; big-softy-theme.el ends here
